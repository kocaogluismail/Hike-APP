        ...
        List{
            ...
            Section{
                ...
                VStack(spacing: 8){
                    Text("Where can you find \nperfect tracks?")
                        .font(.title2)
                        .fontWeight(.heavy)
                    Text("The hike which looks gorgeous in photos but is even better once you are actually there. The hike that you hope to do again someday. \nFind the best day hkes in the app.")
                        .font(.footnote)
                        .italic()
            ...
            Section(
                header:Text("Alternate Icons")) {
                    ...
                    .padding(.top, 12)
                    Text("Choose your favorite app icon from the collection aboce")
            ...
            Section(header: Text("ABOUT THE APP"),
                ...
                CustomListRowView(rowLabel: "Compatibility", rowIcon: "info.circle", rowContent: "İOS,iPadOS", rowTintColor: .red)
